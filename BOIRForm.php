                ...
                <div class="step <?=$step==3?'active':''?> <?=$step>3?'completed':''?>" data-step="3" id="BOIRForm4">
                    ...
                    <div class="form-card beneficial_owners_form" id="BOIRForm4x">
                        ...
                        <div class="special-box">
                            ...
                            <p class="box-content" style="margin: 20px 0px;">Check this box if you are submitting parent/guardian information instead of a minor childâs information.</p>
                        </div>
                        <div class="special-box" style="margin-top: 20px;">
                            ...
                            <div style="margin: 20px 0px;">
                                ...
                                <p class="box-content">By checking this box, youâre indicating that instead of providing the beneficial ownerâs personal information, you will report the legal name(s) of the exempt entity or entities that hold their ownership interest. For example, if the beneficial owner holds their stake through a publicly traded company, you would list the companyâs name rather than the ownerâs details.</p>
                            </div>
                        </div>
                        <div class="tab-fields">
                            <div class="field col1-3">
        ...
        <div class="tab <?=$tab==3?'active':''?> <?=$tab>3?'completed':''?> tab-3" id="BOIRForm6">
            ...
            <div class="tab-fields-header hidden <?php echo ($checkout_processor == 'gpay' || $checkout_processor == 'airwallex') ? 'hidden' : ''; ?>">
                ...
                <div class="payment-tabs-btns">
                    <button class="payment-tab-btn payment_type <?php echo ($checkout_processor == 'braintree') ? 'active' : ''; ?>" id="payment_type_1" data-type="1">Credit Or Dabit Card</button>
